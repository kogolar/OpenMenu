...
struct AboutSettingsPane: View {
    ...
    private var contributeURL: URL {
        // swiftlint:disable:next force_unwrapping
        URL(string: "https://github.com/kogolar/OpenMenu")!
    }
    ...
    private var mainForm: some View {
        OpenMenuForm(padding: EdgeInsets(top: 5, leading: 30, bottom: 30, trailing: 30), spacing: 0) {
    ...
    private var updatesSection: some View {
        OpenMenuSection(options: .hasDividers) {
    ...
    private var bottomBar: some View {
        HStack {
            ...
            Button("Support OpenMenu", systemImage: "heart.circle.fill") {
                openURL(donateURL)
            }
        }
        .padding(8)
