...
struct MenuBarAppearanceEditor: View {
    ...
    private var mainForm: some View {
        OpenMenuForm(padding: mainFormPadding) {
            OpenMenuSection {
                isDynamicToggle
            }
            ...
            OpenMenuSection("Menu Bar Shape") {
                shapePicker
                isInset
            }
    ...
    private var cannotEdit: some View {
        Text("OpenMenu cannot edit the appearance of automatically hidden menu bars")
            .font(.title3)
...
private struct UnlabeledPartialEditor: View {
    ...
    private var tintPicker: some View {
        OpenMenuLabeledContent("Tint") {
            HStack {
                OpenMenuPicker("Tint", selection: $configuration.tintKind) {
    ...
    private var borderColor: some View {
        if configuration.hasBorder {
            OpenMenuLabeledContent("Border Color") {
                CustomColorPicker(
