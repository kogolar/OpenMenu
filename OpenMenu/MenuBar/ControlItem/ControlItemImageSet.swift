...
extension ControlItemImageSet {
    /// The default image set for the OpenMenu icon.
    static let defaultOpenMenuIcon = ControlItemImageSet(
        name: .dot,
        hidden: .catalog("DotFill"),
        visible: .catalog("DotStroke")
    )

    /// The image sets that the user can choose to display in the OpenMenu icon.
    static let userSelectableOpenMenuIcons = [
        ControlItemImageSet(
            name: .arrow,
