...
extension MenuBarItemInfo {
    ...
    /// Information for an item that represents the OpenMenu icon, a.k.a. the
    /// control item for the visible section.
    static let openMenuIcon = MenuBarItemInfo(
        namespace: .ice,
        title: ControlItem.Identifier.openMenuIcon.rawValue
    )
...
extension MenuBarItemInfo.Namespace {
    /// The namespace for menu bar items owned by OpenMenu.
