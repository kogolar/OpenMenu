...
final class MenuBarManager: ObservableObject {
    ...
    /// The panel that contains the OpenMenu Bar interface.
    let openMenuBarPanel: OpenMenuBarPanel
    ...
    init(appState: AppState) {
        self.openMenuBarPanel = OpenMenuBarPanel(appState: appState)
