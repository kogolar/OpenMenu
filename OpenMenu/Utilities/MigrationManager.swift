...
extension MigrationManager {
    ...
    private func migrateControlItems0_8_0() throws {
        ...
        for name in MenuBarSection.Name.allCases {
            ...
            case .visible:
                ControlItem.Identifier.openMenuIcon.deprecatedRawValue
            case .hidden:
...
extension MigrationManager {
    ...
    private func migrateControlItems0_10_1() -> MigrationResult {
        ...
        if needsResetPreferredPositions {
            ...
            let alert = NSAlert()
            alert.messageText = "Due to a bug in the 0.10.0 release, the data for OpenMenu's menu bar items was corrupted and their positions had to be reset."
