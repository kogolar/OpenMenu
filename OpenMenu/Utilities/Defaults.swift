...
extension Defaults {
    enum Key: String {
        ...
        case showOpenMenuIcon = "ShowOpenMenuIcon"
        case openMenuIcon = "OpenMenuIcon"
        case customOpenMenuIconIsTemplate = "CustomOpenMenuIconIsTemplate"
        case useOpenMenuBar = "UseOpenMenuBar"
        ...
        // MARK: OpenMenu Bar Settings

        case openMenuBarLocation = "OpenMenuBarLocation"
        case openMenuBarPinnedLocation = "OpenMenuBarPinnedLocation"
